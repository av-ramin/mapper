...
"""autogenerated by genpy from agv_msgs/SplinePath.msg. Do not edit."""
import codecs
import sys
...
class SplinePath(genpy.Message):
  _md5sum = "80bf4fef0281111824cda232d35d94fe"
  _type = "agv_msgs/SplinePath"
...
float64 incline_angle"""
  ...
  _slot_types = ['std_msgs/Header','agv_msgs/BezierSplinePointWProperties[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SplinePath, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.path:
        ...
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(val1.drive_param)
        buff.write(_struct_I.pack(length))
        for val2 in val1.drive_param:
          _x = val2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = agv_msgs.msg.BezierSplinePointWProperties()
        _v6 = val1.header
        start = end
        end += 4
