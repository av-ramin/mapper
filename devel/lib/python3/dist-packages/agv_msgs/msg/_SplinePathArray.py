...
"""autogenerated by genpy from agv_msgs/SplinePathArray.msg. Do not edit."""
import codecs
import sys
...
class SplinePathArray(genpy.Message):
  _md5sum = "05cf4559b25a14e1afdea5a89a416603"
  _type = "agv_msgs/SplinePathArray"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """agv_msgs/SplinePath[] smooth_paths
================================================================================
...
float64 incline_angle"""
  __slots__ = ['smooth_paths']
  _slot_types = ['agv_msgs/SplinePath[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SplinePathArray, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.smooth_paths is None:
        self.smooth_paths = []
    else:
      self.smooth_paths = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.smooth_paths)
      buff.write(_struct_I.pack(length))
      for val1 in self.smooth_paths:
        _v1 = val1.header
        _x = _v1.seq
        ...
        for val2 in val1.path:
          ...
          _x = _v7
          buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
          length = len(val2.drive_param)
          buff.write(_struct_I.pack(length))
          for val3 in val2.drive_param:
            _x = val3
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.path = []
        for i in range(0, length):
          val2 = agv_msgs.msg.BezierSplinePointWProperties()
          _v10 = val2.header
          start = end
          end += 4
