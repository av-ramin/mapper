...
(cl:defmethod cl:initialize-instance :after ((m <Float64ArrayStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64ArrayStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agv_msgs-msg:<Float64ArrayStamped> is deprecated: use agv_msgs-msg:Float64ArrayStamped instead.")))
