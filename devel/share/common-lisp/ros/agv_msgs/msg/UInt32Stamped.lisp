...
(cl:defmethod cl:initialize-instance :after ((m <UInt32Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UInt32Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agv_msgs-msg:<UInt32Stamped> is deprecated: use agv_msgs-msg:UInt32Stamped instead.")))
