...
(cl:defmethod cl:initialize-instance :after ((m <KeyValue>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyValue)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agv_msgs-msg:<KeyValue> is deprecated: use agv_msgs-msg:KeyValue instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <KeyValue>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agv_msgs-msg:key-val is deprecated.  Use agv_msgs-msg:key instead.")
  (key m))
