...
class Float32MultiArrayStamped {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Float32MultiArrayStamped(null);
  ...
  static datatype() {
    ...
    return 'agv_msgs/Float32MultiArrayStamped';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Float32MultiArrayStamped(null);
...
module.exports = Float32MultiArrayStamped;
