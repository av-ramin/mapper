...
class HumanPoseArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HumanPoseArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.humans[i] = HumanPose.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HumanPoseArray(null);
    ...
    if (msg.humans !== undefined) {
      ...
      for (let i = 0; i < resolved.humans.length; ++i) {
        resolved.humans[i] = HumanPose.Resolve(msg.humans[i]);
      }
    }
    else {
      resolved.humans = []
