...
class WaypointWithVariance {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('variance')) {
        ...
        this.variance = new NavPoseVariance();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NavPoseVariance.serialize(obj.variance, buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new WaypointWithVariance(null);
    ...
    if (msg.variance !== undefined) {
      resolved.variance = NavPoseVariance.Resolve(msg.variance)
    }
    else {
      resolved.variance = new NavPoseVariance()
    }
...
module.exports = WaypointWithVariance;
