...
def create_bool_stamped(msg):
    ...
    stamped_bool.header.frame_id = ""  # Adjust frame_id as per your application
...
def create_twist_stamped(msg):
    ...
    twist_stamped.header.frame_id = ""  # Adjust frame_id as per your application
...
def bool_callback(msg):
    ...
    if not is_sim:
        ...
        #POMPEN
        # brake_enabled.publish(force_brake_msg)
...
if __name__ == "__main__":
    ...
    if is_sim:
        ...
        operator_force_brake = rospy.Publisher(operator_force_brake, BoolStamped, queue_size=10)


    if with_vehicle:
        vehicle_twist_covariance = rospy.Publisher("/AGV_type_4_5_3/vehicle/velocity", TwistWithCovarianceStamped, queue_size=10)
    # Initialize publishers 
    twist_stamped_publisher = rospy.Publisher(output_cmd_vel_stamped_topic, TwistStamped, queue_size=10)
    bool_stamped_publisher = rospy.Publisher(output_bool_stamped_topic, BoolStamped, queue_size=10)
